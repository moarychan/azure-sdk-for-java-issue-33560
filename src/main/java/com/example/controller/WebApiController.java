...
public class WebApiController {
    ...
    private static final String WEB_API_C_URI = "http://localhost:8084/api/webapiC";
    private static final String WEB_API_C_OBO_URI = "http://localhost:8084/api/webapiC/webapiB";
    private static final String WEB_API_C_CC_URI = "http://localhost:8084/api/webapiC/webapiB/clientCredential";

    @GetMapping("/webapp/webapiA/webapiC")
    @ResponseBody
    public String webapiC(@RegisteredOAuth2AuthorizedClient("webapiCUser") OAuth2AuthorizedClient client) {
        return canVisitUri(client, WEB_API_C_URI);
    }

    @GetMapping("/webapp/webapiA/webapiC/obo")
    @ResponseBody
    public String webapiCApplication(@RegisteredOAuth2AuthorizedClient("webapiCUser") OAuth2AuthorizedClient client) {
        return canVisitUri(client, WEB_API_C_OBO_URI);
    }

    @GetMapping("/webapp/webapiC/clientCredential")
    @ResponseBody
    public String webapiCClientCredential(@RegisteredOAuth2AuthorizedClient("webapiCApplication") OAuth2AuthorizedClient client) {
        return canVisitUri(client, WEB_API_C_CC_URI);
    }
}
